...
return [
	...
	'menu' => [
		...
		<div class="alert alert-success">
		    Успешно поръчахте админ панел. Сега можете да видите файловете и да ги свалите неограничен брой пъти.
		</div>
		...
		<p>Това е, отворете вашия домейн и влезте със следните данни:</p>
		<p>
